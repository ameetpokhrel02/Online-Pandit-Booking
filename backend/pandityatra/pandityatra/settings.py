# pandityatra/pandityatra/settings.py

import os # Added os import just in case it's used later
...
# This ensures Python can find 'bookpandit_django' which is a sibling of 'pandityatra'
...
SECRET_KEY = 'django-insecure-qgib@9l3jrb7!yw&&9$=piruuj6ht^t@z)_f!5v36bz#vw6udi'
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    # --- FIX: ADDING THE CUSTOM APP ---
    'bookpandit_django.core', # Assuming 'core' is the module containing the AppConfig
    # ----------------------------------
]
...
WSGI_APPLICATION = 'pandityatra.wsgi.application'
